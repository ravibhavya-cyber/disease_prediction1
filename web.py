...
model_path1 = r"C:\AICTE\diabetes_model.sav"

# Check if file exists
if os.path.exists(model_path1):
    diabetes_model = pickle.load(open(model_path1, 'rb'))
    print("Model loaded successfully!")
# Load pre-trained models
model_path2 = r"C:\AICTE\heart_disease_model.sav"

# Check if file exists
if os.path.exists(model_path2):
    heart_disease_model = pickle.load(open(model_path2, 'rb'))
    print("Model loaded successfully!")

model_path3 = r"C:\AICTE\parkinsons_model.sav"

# Check if file exists
if os.path.exists(model_path3):
    parkinsons_model = pickle.load(open(model_path3, 'rb'))
    print("Model loaded successfully!")
